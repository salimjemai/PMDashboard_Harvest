...
public class Create_Insert_Queries
{
    ...
    public void createUserTables(Statement statement) throws SQLException
    {
    ...
    public void createChangesTables(Statement statement) throws SQLException
    {
        ...
        try
        {
            int executeScript1 = statement.executeUpdate( CreateChangesTblQuery);
        }
        catch (SQLException e)
        { String sqlMessage1 = null;
            if (e != null)
    ...
    public void useDB(Statement statement) throws SQLException
    {
